use crate::{
    indent_of, serialize_or_str, AssetTypeEntry, AssetTypeName, OpMetadata,
    TxnBuilderEntry, TxnMetadata, TxoCacheEntry, TxoName,
};
...
pub fn display_asset_type_defs(
    indent_level: u64,
    ent: &BTreeMap<AssetTypeName, AssetTypeEntry>,
) {
    let ind = indent_of(indent_level);
