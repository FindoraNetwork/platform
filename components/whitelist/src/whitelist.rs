...
use zei::crypto::whitelist::{
    prove_array_membership, verify_array_membership, WhitelistProof,
};
...
impl Whitelist {
    ...
    pub fn prove_membership(
        ...
        prove_array_membership(&self.members, index as usize, &commitment, &blind)
    ...
    pub fn verify_membership(
        ...
        verify_array_membership(&self.members, &commitment, &proof)
            .map_err(|e| PlatformError::ZeiError(error_location!(), e))
    }
}
...
mod tests {
    ...
    use txn_cli::txn_lib::{
        define_issue_transfer_and_get_utxo_and_blinds,
        query_utxo_and_get_type_commitment,
    };
    ...
    fn test_prove_membership_incorrect_index() {
        ...
        let (utxo_1, _, blind_1) = define_issue_transfer_and_get_utxo_and_blinds(
    ...
    fn test_prove_membership_incorrect_utxo() {
        ...
        let prng = &mut ChaChaRng::from_entropy();
        let (utxo_0, _, _) = define_issue_transfer_and_get_utxo_and_blinds(
            &XfrKeyPair::generate(&mut ChaChaRng::from_entropy()),
            &XfrKeyPair::generate(&mut ChaChaRng::from_entropy()),
            10,
            codes[0],
    ...
    fn test_prove_membership_incorrect_blind() {
        ...
        let prng = &mut ChaChaRng::from_entropy();
        let (_, _, blind_0) = define_issue_transfer_and_get_utxo_and_blinds(
            &XfrKeyPair::generate(&mut ChaChaRng::from_entropy()),
            &XfrKeyPair::generate(&mut ChaChaRng::from_entropy()),
            10,
            codes[0],
