...
impl QueryApi {
    pub fn create<T>(
        query_server: Arc<RwLock<QueryServer<T>>>,
        host: &str,
        port: &str,
    ) -> io::Result<QueryApi>
    where
