...
impl Fraction {
    ...
    pub fn checked_new(num: u64, denom: u64) -> Option<Fraction> {
        Some(Fraction(
            I20F12::checked_from_num(num)?
                .checked_div(I20F12::checked_from_num(denom)?)?,
        ))
    }
}
...
pub fn calculate_fee(principal: u64, interest_rate: Fraction) -> u64 {
    (I20F12::from_num(principal) * interest_rate.0)
        .round()
        .to_num()
}
...
pub fn compute_debt_swap_effect(
    ...
    if let Some(returned_debt_output) = returned_debt_output {
        ...
        match (
            ...
            &returned_debt_output.asset_type,
        ) {
            (
                XfrAssetType::NonConfidential(type_a),
    ...
    match (
        ...
        (
            ...
            Ok((
                AssetTypeCode {
                    val: *debt_burned_type,
                },
                DebtSwapEffect {
                    fiat_code: AssetTypeCode { val: *fiat_type },
