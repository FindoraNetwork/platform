  ...
  ($level:ident, $module:ident, $($x:tt)+) => {
    {
      println!("{}  {:10.10}  {:16.16}  {}",
        ...
        TABLE[Modules::$module as usize].name,
        format!($($x)+));
    }
  }
}
    ...
    ($module:ident, $($x:tt)+) => {
      {
        ...
        unsafe {
          if TABLE[Modules::$module as usize].error_enabled() {
    ...
    ($module:ident, $($x:tt)+) => {
      {
        ...
        unsafe {
          if TABLE[Modules::$module as usize].debug_enabled() {
            log_impl!(debug, $module, $($x)+);
          }
        }
      }
    }
    ...
    ($module:ident, $($x:tt)+) => {
      {
        ...
        unsafe {
          if TABLE[Modules::$module as usize].warning_enabled() {
            log_impl!(warning, $module, $($x)+);
          }
        }
      }
    }
    ...
    ($module:ident, $($x:tt)+) => {
      {
        ...
        unsafe {
          if TABLE[Modules::$module as usize].info_enabled() {
            log_impl!(info, $module, $($x)+);
          }
        }
      }
    }
    ...
    ($module:ident, $($x:tt)+) => {
      {
        ...
        unsafe {
          if TABLE[Modules::$module as usize].log_enabled() {
            log_impl!(log, $module, $($x)+);
          }
        }
      }
    }
