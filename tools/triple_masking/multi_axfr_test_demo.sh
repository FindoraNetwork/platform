...
commitment1=$(awk 'FNR>=1 && FNR<=1' commitment_file)
echo "\n\n Owned Abars after Bar to Abar conversion 1"
sleep 20
target/release/fn owned-abars -c $commitment1
commitment2=$(awk 'FNR>=2 && FNR<=2' commitment_file)
