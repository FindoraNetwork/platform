...
sleep 20
"$BIN"/fn owned-abars --commitments "$commitment"

echo -e "\n\n\n ABAR To BAR Conversion"
echo "------------------------------------------------------------------------------"
sleep 5
"$BIN"/fn convert-abar-to-bar --commitment "$commitment" --to-wallet-address  fra1ck6mu4fgmh7n3g0y5jm0zjrq6hwgckut9q2tf5fpwhrdgkhgdp9qhla5t5
