...
sleep 20
target/release/fn owned-abars --commitments "$commitment" --anon-keys $FILE_ANON_KEYS

echo -e "\n\n\n ABAR To BAR Conversion"
echo "------------------------------------------------------------------------------"
sleep 5
target/release/fn convert-abar-to-bar --anon-keys ./$FILE_ANON_KEYS --commitment "$commitment" --to-wallet-address  fra1ck6mu4fgmh7n3g0y5jm0zjrq6hwgckut9q2tf5fpwhrdgkhgdp9qhla5t5
