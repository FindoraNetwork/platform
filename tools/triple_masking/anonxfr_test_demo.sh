...
#randomiser=$(echo | tail -n 1 randomizers)
randomiser=$(cat randomizers)
echo $randomiser > randomizers
randomiser=$(cat randomizers)
echo "\n\n Owned Abars after Bar to Abar conversion"
sleep 2
echo "Input randomiser: $randomiser"
...
echo "\n\n Bar 2 Abar Conversion demo script executed successfully!"
