...
echo "double quit tape enough charge fancy mandate ostrich this program laundry insect either escape cement van turtle loud immense load tip spike inquiry spice" >> mnemonic2
echo "
{
...
echo "==============================================================================="
target/release/fn setup -O mnemonic2 -S http://0.0.0.0

# convert bar to abar
target/release/fn convert-bar-to-abar --anon-keys ./anon-keys-2  --txo-sid 3
