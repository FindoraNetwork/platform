...
#Verify
python $REGRESSION_PATH/evm.py verify-balance --sec-key $BAR_SEC_KEY --amount 839970000
echo
...
python $REGRESSION_PATH/evm.py verify-balance-non-fra --sec-key $BAR_SEC_KEY --amount 839970000 --asset_type $ASSET1
echo
python $REGRESSION_PATH/evm.py verify-balance-non-fra --sec-key $BAR_SEC_KEY --amount 839970000 --asset_type $ASSET2
echo
...
echo "Balance Checked after Asset 2 Bar to Abar Conversion"
...
echo "Checking Balance for Asset 1"
...
echo "Checking Balance for Asset 2"
...
echo "Balances verified for FRA, Asset1 and Asset 2"
