...
impl BankAccount {
    ...
    const BANK_ACCOUNT_PUBKEY: &'static str = "Oa2RRTzdayA8V2OBE7xp3n3NKrjGJxFTSZZybXOXCDQ=";
    const BANK_ACCOUNT_SECKEY: &'static str = "Ew9fMaryTL44ZXnEhcF7hQ-AB-fxgaC8vyCH-hCGtzg=";
